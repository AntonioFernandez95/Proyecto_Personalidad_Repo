...
@rx.page(
    route="/academia/tecnica/flexiones", 
    title="Academia Online - Técnica de Flexiones", 
    on_load=[FisicasState.check_plan_fisicas, DetallesTecnicasState.cargar_datos_prueba]
)
def flexiones() -> rx.Component:
    return academia_layout(
        rx.vstack(
            # TÍTULO (Usamos el del estado o uno fijo para asegurar)
            rx.text(
            ...
            rx.box(
                rx.vstack(
                    ...
                    rx.image(
                        src="/EJERCICIO_METODOS_FLEXIONES.webp",
                        width="100%",
                        height="auto",
                        border_radius="12px",
                        margin_y="1.5em"
