    ...
    return rx.box(
        rx.hstack(
            rx.hstack(
                ...
                rx.text(
                    "ACADEMIA ONLINE",
                    font_size="1.2em", font_weight="800",
                    color="white", letter_spacing="0.12em",
                ),
            ...
            rx.hstack(
                rx.link(
                    "Pruebas Físicas",
                    color="rgba(255,255,255,0.85)", font_size="0.9em",
                ...
                rx.divider(orientation="vertical", height="1.2em"),
                rx.button(
                    "Cerrar Sesión",
                    variant="ghost",
