...
@rx.page(route="/academia/fisicas", title="Academia Online - Pruebas Físicas", on_load=CalculadoraState.check_fisicas_access)
def fisicas() -> rx.Component:
    return academia_layout(
        ...
        rx.grid(
            small_card("circle-play",   "Presentación",     "Introducción al curso",  "Ver módulo", "/academia/curso"),
