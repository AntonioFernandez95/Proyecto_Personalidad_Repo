...
class AdminState(State):
    ...
    # --- CONFIRMACIÓN DE BORRADO DE RECURSOS ---
    recurso_a_borrar: dict = {}
    ...
    def solicitar_borrar_recurso(self, recurso: dict):
        """Abre el diálogo de confirmación para borrar un recurso."""
        self.recurso_a_borrar = recurso
        self.show_confirm_delete = True




    def cancelar_borrar_recurso(self):
        """Cierra el diálogo de confirmación."""
        self.show_confirm_delete = False
        self.recurso_a_borrar = {}




    def confirmar_borrar_recurso(self):
        """Ejecuta el borrado real del recurso solicitado."""
        self.show_confirm_delete = False
        if self.recurso_a_borrar:
            self.borrar_recurso(self.recurso_a_borrar)
            self.recurso_a_borrar = {}
